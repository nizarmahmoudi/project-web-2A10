                   ...
                   -->
                    <form method="POST" action="ajoutercategorie.php">
                          <table>
                            <tr>
                              <td>
                                <input type="text" id="nomprenom" class="nomprenom" name="idC" required>
                            ...
                            <tr>
                              <td>
                                <input type="text" id="email" class="email" name="nomC" required>
                            ...
                            <tr>
                              <td>
                                <input type="text" id="age" class="age" name="famille" required>
                            ...
                            <tr>
                              <td>
                                <input type="submit" name="ajouter" value="ajouter", enctype="multipart/form-data">
                              </td>
                            </tr>
                      ...
                      <div class="modal-body mx-3">
                        ...
                        <form method="POST" action="ajouterproduit.php">
                          <table>
                            ...
                            <tr>
                              <td>
                                <input type="text" id="specialite" class="specialite" name="nomP" required>
                            ...
                            <tr>
                              <td>
                                <input type="number" id="age" class="age" name="quantiteP" required>
                            ...
                            <tr>
                              <td>
                                <input type="text" id="specialite" class="specialite" name="description" required>
                            ...
                            <tr>
                              <td>
                                <input type="text" id="experience" class="ecperience" name="prix" required>
