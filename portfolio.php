		...
		<nav class="navbar navbar-expand-lg navbar-dark">
			...
			<div class="collapse navbar-collapse text-center" id="navigation">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item">
						<a class="nav-link" href="coachs.html">Nos Coachs</a></a>
					</li>
					<li class="nav-item">
			...
			<div class="col-12">
				<div class="isotope-nav" data-isotope-nav="isotope">
					<ul>
						...
						<li><a href="#" data-filter=".web-design">accesoires</a></li>
						<li><a href="#" data-filter=".development">pre-workout</a></li>
						<li><a href="#" data-filter=".joomla">gainer</a></li>
						<li><a href="#" data-filter=".wordpress">Hard gainer</a></li>
					</ul>
				</div>
			</div>
...
foreach($listeproduits as $row){
  ...
  <div>Nom:<?PHP echo $row['nomP']; ?></div>
  <div>Prix:<?PHP echo $row['prix']; ?>Dt</div>
  <a><img class="" src="images\portfolio\<?php echo $row['image'];?>" style="width: 200px; height:200px;"></a></td>
